...
| ---------------- | ------------------------------------------------------------------------ | 
| `step`           | Simulated time step in the transaction sequence                          | 
| `type`           | Type of transaction                                                      | 
| `amount`         | Money transferred in the transaction                                     | 
...
| `isFraud`        | **Target variable** — tells whether the transaction is fraudulent        | 
| `isFlaggedFraud` | Existing rule-based flag indicating a potentially fraudulent transaction | 
...
XG Boost                  91.93%	   86.00%	      88.87%	      99.56%	    92.52%
